...
cutoff = 55
val, xt, kta, kto, xw, kwa, kwo = tallwide_t_test(5,Nt,m,cutoff=cutoff)
...
tax.errorbar(xw,kwa,ls='None',color='red',marker='x',yerr=kwo,capsize = 3,label='Initially wide network')
tax.set_yscale('log')
tax.set_xscale('log')
